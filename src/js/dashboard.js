...
$(function(){
    ...
    $(".custom-dropdown-menu li a").click(function(){
        $(".custom-dropdown-menu > li > a").removeClass("selected");
        $(this).addClass("selected"); 
        $(".custom-dropdown-btn:first-child").text($(this).text());
        $(".custom-dropdown-btn:first-child").val($(this).text());
    });
